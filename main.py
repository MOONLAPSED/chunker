...
class FilesystemState:
    ...
    allowed_root: Path = project_root  # Assuming this should be allowed root
    
    def __init__(self):
        if not str(self.project_root).startswith(str(self.allowed_root)):
            raise ValueError("Project root is not the parent of the file's directory")
